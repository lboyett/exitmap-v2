...
router.post("/", async (req, res) => {
  ...
  async function main() {
    ...
    let info = await transporter.sendMail({
      ...
      html: `<h1>Hello!</h1><br><p>This message was sent to you by ExitMap.</p><br><p>To verify your email, please click the following link:</p><br><h2>http//${process.env.CLIENT_DOMAIN}/verify-user?uuid=${uuid}</h2>`, // html body
    });
  }
